...
export default function Docs(props){
	...
	var title = "";
	if (docIsValid) title = `${args.subject} - ${urlDicts[args.subject][args.title]}`;
	else title = "Doc not found.";
	return(
		<Box>
			...
			<Box className={classes.flexBox} mt={4} px={10}>
				...
				<span><Tooltip placement="top" title="Download"><IconButton color="primary"><DownloadIcon/></IconButton></Tooltip></span>
			</Box>
			<Box mt={1} mb={2} px={10}>
